...
import { Award, Ruler, Sparkles, ChevronLeft, ChevronRight, Book } from "lucide-react"
        ...
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/80">
          <div className="container mx-auto flex h-20 items-center justify-between px-4">
            ...
            <nav className="hidden items-center gap-8 md:flex">
              <Link href="#produtos" style={{ "--hover-color": config?.cor_primaria } as React.CSSProperties} className="text-sm font-medium transition-colors hover:text-(--hover-color)">
                Produtos
              </Link>
              <Link href="#sobre" style={{ "--hover-color": config?.cor_primaria } as React.CSSProperties} className="text-sm font-medium transition-colors hover:text-(--hover-color)">
                Sobre Nós
              </Link>
              <Link href="#contato" style={{ "--hover-color": config?.cor_primaria } as React.CSSProperties} className="text-sm font-medium transition-colors hover:text-(--hover-color)">
                Contato
              </Link>
            </nav>
          </div>
        ...
        >
          <div className="container relative z-10 px-4 py-20 mx-auto text-center">
            ...
            <p className="mb-8 text-lg text-muted-foreground text-pretty md:text-xl">
              Criamos peças exclusivas com madeira de qualidade, unindo tradição e design moderno para transformar
              seu espaço.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Button size="lg" style={{ "--hover-color": config?.cor_primaria } as React.CSSProperties} className="text-(--hover-color) px-8 bg-white/80 backdrop-blur shadow-lg hover:bg-(--hover-color) hover:text-white">
                Faça um orçamento
              </Button>
            </div>
          </div>
